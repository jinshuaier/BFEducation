...
//    } else {
    [imageView sd_setImageWithURL:[NSURL URLWithString:[self placeholderImageForIndex:index]] placeholderImage:[UIImage imageNamed:@"组3"]];
//    }
...
- (void)showFirstImage{
    ...
    [tmpImageView sd_setImageWithURL:[NSURL URLWithString:[self placeholderImageForIndex:self.currentImageIndex]] placeholderImage:[UIImage imageNamed:@"组3"]];
...
- (NSString *)placeholderImageForIndex:(NSInteger)index{
    if ([self.delegate respondsToSelector:@selector(photoBrowser:placeholderImageForIndex:)]) {
        NSString *url = [self.delegate photoBrowser:self placeholderImageForIndex:self.currentImageIndex];
        return url;
    }
    return nil;
}
