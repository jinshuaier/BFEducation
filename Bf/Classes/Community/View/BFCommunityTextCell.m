//
//  BFCommunityTextCell.m
//  Bf
//
//  Created by 春晓 on 2017/12/13.
//  Copyright © 2017年 陈大鹰. All rights reserved.
//

#import "BFCommunityTextCell.h"

@interface BFCommunityTextCell()
// 头像
...
@implementation BFCommunityTextCell{
    UIView *lineView;
    UIView *lineView1;
    UIView *lineView2;
}
...
- (void)layout{
    ...
    .topSpaceToView(_contentLabel, PXTOPT(26))
...
- (void)setModel:(BFCommunityModel *)model{
    ...
    _model = model;
    [_headImageView sd_setImageWithURL:[NSURL URLWithString:_model.iPhoto] placeholderImage:[UIImage imageNamed:@"组3"]];
