...
- (void)loadSubbview{
    ...
    _webview =[[UIWebView alloc]initWithFrame:CGRectMake((KScreenW-width)/2,70,width,height)];
    ...
    _downloadBtn.frame =CGRectMake((KScreenW-36)/2,210+10, 36, 36);
    ...
    _label =[[UILabel alloc]initWithFrame:CGRectMake((KScreenW-80)/2,CGRectGetMaxY(_downloadBtn.frame), 80, 17)];
    _label.text =@"保存本地";
