...
@interface BFWatchCourseVideoVC ()<UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate,DWGestureViewDelegate,UIAlertViewDelegate,DWVideoPlayerDelegate,TreeTableCellDelegate>
{
...
@implementation BFWatchCourseVideoVC{
    UILabel *titleLabel;
    UILabel *lineLabel;
}
...
- (void)startRequestAdInfo
{
    ...
    if ([_type isEqualToString:@"2"]) {
        //暂停广告
        __weak BFWatchCourseVideoVC *blockslf = self;
    ...
    if ([_type isEqualToString:@"1"]) {
        //片头广告
        __weak BFWatchCourseVideoVC *blockself = self;
        _adInfo.finishBlock = ^(NSDictionary *response){
