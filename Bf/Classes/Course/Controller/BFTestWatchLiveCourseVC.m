...
@interface BFTestWatchLiveCourseVC ()<UITextFieldDelegate,RequestDataDelegate,UIScrollViewDelegate,LianMaiDelegate,UIAlertViewDelegate>
/*
 * 是否横屏模式
 */
...
@implementation BFTestWatchLiveCourseVC
...
-(UIButton *)leftButton {
    if(!_leftButton) {
        ...
        UIImage *aimage = [UIImage imageNamed:@"backWhite"];
