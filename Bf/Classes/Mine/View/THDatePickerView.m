...
- (void)configToolView {
    ...
    self.toolView.backgroundColor = RGBColor(240, 240, 240);
    [self addSubview:self.toolView];
    
    UIButton *saveBtn = [[UIButton alloc] init];
    saveBtn.frame = CGRectMake(self.frame.size.width - 50, 2, 40, 40);
    [saveBtn setTitle:@"确定" forState:(UIControlStateNormal)];
    [saveBtn setTitleColor:RGBColor(151, 151, 151) forState:(UIControlStateNormal)];
    ...
    [cancelBtn setTitleColor:RGBColor(151, 151, 151) forState:(UIControlStateNormal)];
