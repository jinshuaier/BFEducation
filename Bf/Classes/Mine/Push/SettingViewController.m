...
//    [self.navigationController.navigationBar setShadowImage:[UIImage new]];
    ...
    [_informationLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(ws.view).with.offset(CCGetRealFromPt(54));
    ...
    [_screenDirection mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(ws.informationLabel.mas_bottom).with.offset(CCGetRealFromPt(52));
...
-(void)startPushAction {
    ...
    self.pushViewController.modalPresentationStyle = 0;
