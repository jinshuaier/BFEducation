//
//  BFHomePlayBackCollectionCell.m
//  Bf
//
//  Created by 陈大鹰 on 2018/5/30.
//  Copyright © 2018年 陈大鹰. All rights reserved.
//

#import "BFHomePlayBackCollectionCell.h"
@interface BFHomePlayBackCollectionCell()
// img
...
@implementation BFHomePlayBackCollectionCell
...
- (void)setCourseDict:(NSDictionary *)courseDict{
    ...
    if ([_courseDict[@"hotnum"] integerValue] >= 10000) {
        _showCountLabel.text = [NSString stringWithFormat:@"%.2lf万次播放",[_courseDict[@"livenum"] integerValue] / 10000.0];
    }else{
        _showCountLabel.text = [NSString stringWithFormat:@"%@次播放",_courseDict[@"livenum"]];
    }
