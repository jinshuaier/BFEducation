...
-(void)layoutSubviews {
    self.newsImgOne.frame = CGRectMake(10, 10, 107, 71);
    self.newsTitleOne.frame = CGRectMake(self.newsImgOne.right + 10, 10, KScreenW - 20 - 107 - 10 - 10 - 10, 40);
    self.newsContentOne.frame = CGRectMake(self.newsImgOne.right + 10, self.newsTitleOne.bottom + 10, KScreenW - 20 - 120 - 30, 16);
